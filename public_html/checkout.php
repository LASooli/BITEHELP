...
<?php
if (isset($_POST['quantity-selector'])) {
    $quantity = $_POST['quantity-selector'];
...
<div class="split">
    <div class="left-side">
        <div class="checkout-header">
            <a style="text-decoration: none;" href="index.php" ><div id='header' style="text-align: center"><h1 style="color: red; display: inline;">BITE</h1><h1 style='display: inline; color: whitesmoke'>HELP</h1></div></a>
            ...
            <script>
                ...
                //UPDATE: The paypal can still use javascript price. Make sure it is recording the correct price every time.
    ...
    <div class="right-side">
        ...
        <div class="order-summary">
            ...
            <div class="quantity-display">
                <h4>Quantity</h4>
                    <div class="quantity-value-box"><span><?php echo"$quantity"; ?></span></div>
                    <input type="button" value='EDIT' class="edit-quantity" onclick="window.location.href='index.php'">
            ...
            <div class="total-cost-display">
                <h3>Total cost</h3>
                <p style="font-size: large">$<?php echo"$totalCost"?></p>
            </div>
        </div>
        <div id="errors"></div>
